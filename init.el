...
(custom-set-variables
 ...
 '(notmuch-identities '("thork@tuta.io"))
 '(notmuch-search-oldest-first nil)
 '(notmuch-show-logo nil)
 '(nrepl-message-colors
	 '("#CC9393" "#DFAF8F" "#F0DFAF" "#488249" "#95d291" "#57a2a4" "#93E0E3" "#DC8CC3" "#bbb0cb"))
 '(org-agenda-clockreport-parameter-plist '(:link t :maxlevel 2 :block today :scope agenda))
 ...
 '(org-agenda-window-frame-fractions '(0.5 . 0.5))
