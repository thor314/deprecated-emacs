...
(custom-set-variables
 ...
 '(exec-path
	 (quote
		("/usr/local/go/bin" "~/go/bin" "~/.cargo/bin" "/usr/local/bin" "~/.nvm/versions/node/v14.12.0/bin/" "/usr/local/bin/" "/usr/bin/" "/bin/" "/usr/sbin/" "/sbin/" "/usr/local/go/bin/" "/Applications/Emacs.app/Contents/MacOS/bin-x86_64-10_14/" "/Applications/Emacs.app/Contents/MacOS/libexec-x86_64-10_14/" "/Applications/Emacs.app/Contents/MacOS/libexec/")))
