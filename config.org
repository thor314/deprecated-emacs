...
** Please don't create annoying .#<backup> files
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
	(use-package zoom
		:config (zoom-mode t))
#+end_src
*** (Centaur) Tabs - move around with CM-[',]
[[https://github.com/ema2159/centaur-tabs][Tabbing]].
#+begin_src emacs-lisp
...
** XKCD
get [[https://github.com/vibhavp/emacs-xkcd][xkcd]].
#+begin_src emacs-lisp
	(use-package xkcd)
